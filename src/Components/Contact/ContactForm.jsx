            ...
            <Row>
                <Col lg={6}>
                    <Form.Group className="mb-3" controlId="formBasicName">
                        <Form.Control className={`input-field`} type="text" placeholder="Name" name="name" value={formData.name} onChange={handleChange} />
                    </Form.Group>
                </Col>
                <Col lg={6}>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        <Form.Control className={`input-field`} type="email" placeholder="Email" name="email" value={formData.email} onChange={handleChange} />
                    </Form.Group>
                </Col>
            </Row>
            <Row>
                <Col>
                    <Form.Group className="mb-3" controlId="formBasicName">
                        <Form.Control className={`input-field`} type="text" placeholder="Subject" name="subject" value={formData.subject} onChange={handleChange} />
                    </Form.Group>
                </Col>
            </Row>
            <Row>
                    <Form.Group className="mb-3" controlId="formBasicName">
                        <Form.Control className={`input-field `} as="textarea" rows={5} placeholder="Message..." name="message" value={formData.message} onChange={handleChange} />
                    </Form.Group>
            </Row>
                <Button type="submit" className='button my-4 mr-0' style={{float: "right"}}>
                    {buttonText}
                </Button>
          </Form>
        </Col>
          ...
          <div>
            ...
            <div>
              <div className="d-flex">
                {/* icon */}
                <div className="d-flex">
                  <span className="upper-icon d-flex align-items-center"><i class="fa-solid fa-envelope-open fs-3"></i></span>
                </div> 
                {/* subject */}
                <div style={{width: "300px"}}>
                  <div className="upper-icon-title">Mail</div>
                  <div className="upper-icon-content">002chandra.yogesh@gmail.com</div>
              ...
              <div className="d-flex">
                ...
                <div className="d-flex align-items-center">
                  <span className="upper-icon d-flex align-items-center"><i class="fa-solid fa-square-phone fs-2"></i></span>
                </div> 
                {/* subject */}
                <div style={{width: "300px"}}>
            ...
            <div className="contact-social-links d-flex">
              <ul className="social-links text-center">
                <li><a href="http://github.com/Yogesh-nin/" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-github"></i></a></li>
